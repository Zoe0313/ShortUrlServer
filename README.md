...
127.0.0.1:6379> json.set ":src.schema.Url:01J50VTM51AYC96DFYGBVXHYA0" . '{\"pk\":\"01J50VTM51AYC96DFYGBVXHYA0\",\"original_url\":\"https://docs.vdp.vmware.com/docs/using_kubernetes/monitoring/monitoring_kps/\",\"hash_original\":\"f416111a42c23cd41676ff4ac263159ae3f566e12322afbe4765f93debac9500\",\"short_key\":\"Bav7T\",\"create_at\":\"2024-08-11\",\"expire_time\":null,\"user_id\":\"lzoe\"}'
```
...
way3:
```
$ redis-cli -u redis://default:shorturl@localhost:10001
```
way4:
```
